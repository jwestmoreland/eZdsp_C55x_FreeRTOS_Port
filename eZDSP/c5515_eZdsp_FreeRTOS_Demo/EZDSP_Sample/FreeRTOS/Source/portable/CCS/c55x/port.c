...
// 
	...
	*pxTopOfStack = ( portSTACK_TYPE ) DBSTAT_LOW;
	pxTopOfStack--;
//	*pxTopOfStack = ( portSTACK_TYPE ) DBSTAT_HIGH;
//	pxTopOfStack--;
	*pxTopOfStack = ( portSTACK_TYPE ) STATUS0_LOW;
	pxTopOfStack--;
//	*pxTopOfStack = ( portSTACK_TYPE ) STATUS0_HIGH;
//	pxTopOfStack--;
	*pxTopOfStack = ( portSTACK_TYPE ) STATUS2_LOW;
	pxTopOfStack--;
//	*pxTopOfStack = ( portSTACK_TYPE ) STATUS2_HIGH;
//	pxTopOfStack--;
	*pxTopOfStack = ( portSTACK_TYPE ) STATUS1_LOW;
	pxTopOfStack--;
...
//	pxTopOfStack--;
	*pxTopOfStack = ( portSTACK_TYPE ) (((unsigned long)(pxCode))>>16);
	pxTopOfStack--;
