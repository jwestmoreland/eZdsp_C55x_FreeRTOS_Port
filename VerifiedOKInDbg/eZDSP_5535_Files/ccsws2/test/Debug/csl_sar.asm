...
;* Date/Time created: Sat Sep 08 23:29:23 2018                                 *
;*******************************************************************************
...
$C$DW$4	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$4, DW_AT_name("F:\eZdsp_C55x_FreeRTOS_Port\VerifiedOKInDbg\eZDSP_5535_Files\ccsws2\test\Debug\csl_sar.asm:$C$L1:1:1536474563")
