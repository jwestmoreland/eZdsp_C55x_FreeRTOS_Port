...
;* Date/Time created: Sat Nov 24 20:14:49 2012                                 *
;*******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("C:\temp\ccsws2\test\Debug")
;******************************************************************************
;* CINIT RECORDS                                                              *
;******************************************************************************
	.sect	".cinit"
	...
	.field  	0,8
	.field	5000,16			; _xFreeBytesRemaining @ 0
...
;	C:\ti\ccsv5\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Users\\John\\AppData\\Local\\Temp\\0767212 
	.sect	".text"
	.align 4
...
$C$DW$8	.dwtag  DW_TAG_subprogram, DW_AT_name("pvPortMalloc")
	...
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(0x0e)
...
$C$DW$12	.dwtag  DW_TAG_variable, DW_AT_name("pxBlock")
	.dwattr $C$DW$12, DW_AT_TI_symbol_name("_pxBlock")
...
$C$DW$13	.dwtag  DW_TAG_variable, DW_AT_name("pxPreviousBlock")
	.dwattr $C$DW$13, DW_AT_TI_symbol_name("_pxPreviousBlock")
...
$C$DW$14	.dwtag  DW_TAG_variable, DW_AT_name("pxNewBlockLink")
	.dwattr $C$DW$14, DW_AT_TI_symbol_name("_pxNewBlockLink")
...
$C$DW$15	.dwtag  DW_TAG_variable, DW_AT_name("pvReturn")
	.dwattr $C$DW$15, DW_AT_TI_symbol_name("_pvReturn")
	.dwattr $C$DW$15, DW_AT_type(*$C$DW$T$3)
	.dwattr $C$DW$15, DW_AT_location[DW_OP_bregx 0x24 8]
        MOV T0, *SP(#0) ; |155| 
...
$C$DW$16	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$16, DW_AT_name("_vTaskSuspendAll")
...
$C$DW$18	.dwtag  DW_TAG_variable, DW_AT_name("pxFirstFreeBlock")
	.dwattr $C$DW$18, DW_AT_TI_symbol_name("_pxFirstFreeBlock")
...
$C$L1:    
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 174,column 4,is_stmt
        MOV *(#_heapSTRUCT_SIZE), AR1 ; |174| 
        ADD *SP(#0), AR1, AR1 ; |174| 
        MOV AR1, *SP(#0) ; |174| 
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 180,column 5,is_stmt
        AND #0x0003, AR1, AR1 ; |180| 
        SUB AR1, *SP(#0), AR1 ; |180| 
        ADD #4, AR1 ; |180| 
        MOV AR1, *SP(#0) ; |180| 
$C$L2:    
...
||      AADD AR1, AR3 ; |213| 
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 217,column 6,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#2)), AC0 ; |217| 
        MOV dbl(*SP(#6)), XAR3
        SUB uns(*SP(#0)), AC0, AC0 ; |217| 
        MOV AC0, *AR3(short(#2)) ; |217| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 218,column 6,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *SP(#0), AR1 ; |218| 
        MOV AR1, *AR3(short(#2)) ; |218| 
...
$C$DW$21	.dwtag  DW_TAG_variable, DW_AT_name("xBlockSize")
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 221,column 6,is_stmt
        MOV dbl(*SP(#6)), XAR3
        MOV *AR3(short(#2)), AR1 ; |221| 
        AMOV #_xStart, XAR3 ; |221| 
        MOV AR1, *SP(#12) ; |221| 
        MOV XAR3, dbl(*SP(#10))
        MOV dbl(*AR3), XAR3
        MOV *SP(#12), AR1 ; |221| 
        MOV *AR3(short(#2)), AR2 ; |221| 
...
$C$L8:    
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 224,column 5,is_stmt
        MOV *(#_xFreeBytesRemaining), AC0 ; |224| 
        SUB uns(*SP(#0)), AC0, AC0 ; |224| 
        MOV AC0, *(#_xFreeBytesRemaining) ; |224| 
$C$L9:    
...
$C$DW$24	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$24, DW_AT_name("C:\temp\ccsws2\test\Debug\heap_2.asm:$C$L6:1:1353816889")
	.dwattr $C$DW$24, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$24, DW_AT_TI_begin_line(0xdd)
	.dwattr $C$DW$24, DW_AT_TI_end_line(0xdd)
$C$DW$25	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$25, DW_AT_low_pc($C$DW$L$_pvPortMalloc$15$B)
	.dwattr $C$DW$25, DW_AT_high_pc($C$DW$L$_pvPortMalloc$15$E)
	.dwendtag $C$DW$24


$C$DW$26	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$26, DW_AT_name("C:\temp\ccsws2\test\Debug\heap_2.asm:$C$L4:1:1353816889")
	.dwattr $C$DW$26, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$26, DW_AT_TI_begin_line(0xbe)
	.dwattr $C$DW$26, DW_AT_TI_end_line(0xc1)
$C$DW$27	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$27, DW_AT_low_pc($C$DW$L$_pvPortMalloc$10$B)
	.dwattr $C$DW$27, DW_AT_high_pc($C$DW$L$_pvPortMalloc$10$E)
$C$DW$28	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$28, DW_AT_low_pc($C$DW$L$_pvPortMalloc$11$B)
	.dwattr $C$DW$28, DW_AT_high_pc($C$DW$L$_pvPortMalloc$11$E)
$C$DW$29	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$29, DW_AT_low_pc($C$DW$L$_pvPortMalloc$9$B)
	.dwattr $C$DW$29, DW_AT_high_pc($C$DW$L$_pvPortMalloc$9$E)
	.dwendtag $C$DW$26
...
$C$DW$30	.dwtag  DW_TAG_subprogram, DW_AT_name("vPortFree")
	.dwattr $C$DW$30, DW_AT_low_pc(_vPortFree)
	.dwattr $C$DW$30, DW_AT_high_pc(0x00)
	.dwattr $C$DW$30, DW_AT_TI_symbol_name("_vPortFree")
	.dwattr $C$DW$30, DW_AT_external
	.dwattr $C$DW$30, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$30, DW_AT_TI_begin_line(0xf4)
	.dwattr $C$DW$30, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$30, DW_AT_TI_max_frame_size(0x0a)
...
$C$DW$31	.dwtag  DW_TAG_formal_parameter, DW_AT_name("pv")
	.dwattr $C$DW$31, DW_AT_TI_symbol_name("_pv")
...
_vPortFree:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-9, SP
	.dwcfi	cfa_offset, 10
$C$DW$32	.dwtag  DW_TAG_variable, DW_AT_name("pv")
...
$C$DW$34	.dwtag  DW_TAG_variable, DW_AT_name("pxLink")
	.dwattr $C$DW$34, DW_AT_TI_symbol_name("_pxLink")
...
$C$DW$37	.dwtag  DW_TAG_variable, DW_AT_name("pxIterator")
	.dwattr $C$DW$37, DW_AT_TI_symbol_name("_pxIterator")
	.dwattr $C$DW$37, DW_AT_type(*$C$DW$T$26)
	.dwattr $C$DW$37, DW_AT_location[DW_OP_bregx 0x24 6]
$C$DW$38	.dwtag  DW_TAG_variable, DW_AT_name("xBlockSize")
	.dwattr $C$DW$38, DW_AT_TI_symbol_name("_xBlockSize")
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 261,column 4,is_stmt
        MOV dbl(*SP(#4)), XAR3
        MOV *AR3(short(#2)), AR1 ; |261| 
        MOV AR1, *SP(#8) ; |261| 
        AMOV #_xStart, XAR3 ; |261| 
        MOV XAR3, dbl(*SP(#6))
        MOV dbl(*AR3), XAR3
        MOV *SP(#8), AR1 ; |261| 
        MOV *AR3(short(#2)), AR2 ; |261| 
...
$C$L11:    
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 262,column 4,is_stmt
        MOV dbl(*SP(#4)), XAR3
        MOV *AR3(short(#2)), AR1 ; |262| 
        ADD *(#_xFreeBytesRemaining), AR1, AR1 ; |262| 
        MOV AR1, *(#_xFreeBytesRemaining) ; |262| 
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 264,column 3,is_stmt
$C$DW$39	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$39, DW_AT_low_pc(0x00)
	.dwattr $C$DW$39, DW_AT_name("_xTaskResumeAll")
...
$C$DW$41	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$41, DW_AT_name("C:\temp\ccsws2\test\Debug\heap_2.asm:$C$L10:1:1353816889")
	.dwattr $C$DW$41, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$41, DW_AT_TI_begin_line(0x105)
	.dwattr $C$DW$41, DW_AT_TI_end_line(0x105)
$C$DW$42	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$42, DW_AT_low_pc($C$DW$L$_vPortFree$3$B)
	.dwattr $C$DW$42, DW_AT_high_pc($C$DW$L$_vPortFree$3$E)
	.dwendtag $C$DW$41

	.dwattr $C$DW$30, DW_AT_TI_end_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
...
$C$DW$43	.dwtag  DW_TAG_subprogram, DW_AT_name("xPortGetFreeHeapSize")
	.dwattr $C$DW$43, DW_AT_low_pc(_xPortGetFreeHeapSize)
	.dwattr $C$DW$43, DW_AT_high_pc(0x00)
	.dwattr $C$DW$43, DW_AT_TI_symbol_name("_xPortGetFreeHeapSize")
	.dwattr $C$DW$43, DW_AT_external
	.dwattr $C$DW$43, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$43, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$43, DW_AT_TI_begin_line(0x10d)
...
_xPortGetFreeHeapSize:
	...
	.dwpsn	file "../FreeRTOS/Source/portable/MemMang/heap_2.c",line 271,column 2,is_stmt
        MOV *(#_xFreeBytesRemaining), T0 ; |271| 
...
$C$DW$44	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$44, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$43, DW_AT_TI_end_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$43, DW_AT_TI_end_line(0x110)
...
$C$DW$45	.dwtag  DW_TAG_subprogram, DW_AT_name("vPortInitialiseBlocks")
	.dwattr $C$DW$45, DW_AT_low_pc(_vPortInitialiseBlocks)
	.dwattr $C$DW$45, DW_AT_high_pc(0x00)
	.dwattr $C$DW$45, DW_AT_TI_symbol_name("_vPortInitialiseBlocks")
	.dwattr $C$DW$45, DW_AT_external
	.dwattr $C$DW$45, DW_AT_TI_begin_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
	.dwattr $C$DW$45, DW_AT_TI_begin_line(0x113)
	.dwattr $C$DW$45, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$45, DW_AT_TI_max_frame_size(0x01)
...
$C$DW$46	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$46, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$45, DW_AT_TI_end_file("../FreeRTOS/Source/portable/MemMang/heap_2.c")
...
$C$DW$47	.dwtag  DW_TAG_member
	...
	.dwattr $C$DW$47, DW_AT_name("pxNextFreeBlock")
	.dwattr $C$DW$47, DW_AT_TI_symbol_name("_pxNextFreeBlock")
	.dwattr $C$DW$47, DW_AT_data_member_location[DW_OP_plus_uconst 0x0]
	.dwattr $C$DW$47, DW_AT_accessibility(DW_ACCESS_public)
$C$DW$48	.dwtag  DW_TAG_member
	.dwattr $C$DW$48, DW_AT_type(*$C$DW$T$20)
	.dwattr $C$DW$48, DW_AT_name("xBlockSize")
	.dwattr $C$DW$48, DW_AT_TI_symbol_name("_xBlockSize")
...
$C$DW$T$25	.dwtag  DW_TAG_typedef, DW_AT_name("xBlockLink")
...
$C$DW$T$23	.dwtag  DW_TAG_array_type
	...
	.dwattr $C$DW$T$23, DW_AT_byte_size(0x1388)
$C$DW$49	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$49, DW_AT_upper_bound(0x1387)
	.dwendtag $C$DW$T$23
...
$C$DW$T$22	.dwtag  DW_TAG_volatile_type
	.dwattr $C$DW$T$22, DW_AT_type(*$C$DW$51)
...
$C$DW$T$24	.dwtag  DW_TAG_union_type
	.dwattr $C$DW$T$24, DW_AT_name("xRTOS_HEAP")
	.dwattr $C$DW$T$24, DW_AT_byte_size(0x1388)
