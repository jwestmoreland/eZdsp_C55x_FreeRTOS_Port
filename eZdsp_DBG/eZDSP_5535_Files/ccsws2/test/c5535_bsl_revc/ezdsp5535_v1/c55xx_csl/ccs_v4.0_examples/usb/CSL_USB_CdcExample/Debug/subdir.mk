...
./csl_usb_cdc_example.obj: ../csl_usb_cdc_example.c $(GEN_OPTS)
	...
	"C:/Program Files/Texas Instruments/C5500 Code Generation Tools 4.3.6/bin/cl55" -v5505 -g --define="_DEBUG" --include_path="C:/Program Files/Texas Instruments/C5500 Code Generation Tools 4.3.6/include" --include_path="C:/test/c55_csl/c55xx_csl/ccs_v4.0_examples/usb/CSL_USB_CdcExample/Debug" --include_path="C:/Program Files/Texas Instruments/bios_5_41_02_14/packages/ti/bios/include" --include_path="C:/Program Files/Texas Instruments/bios_5_41_02_14/packages/ti/rtdx/include/c5500" --include_path="/packages/ti/xdais" --include_path="C:/test/c55_csl/c55xx_csl/src" --include_path="C:/test/c55_csl/c55xx_csl/inc" --diag_warning=225 --large_memory_model --algebraic --asm_source=algebraic --asm_listing --preproc_with_compile --preproc_dependency="csl_usb_cdc_example.pp" $(GEN_OPTS_QUOTED) $(subst #,$(wildcard $(subst $(SPACE),\$(SPACE),$<)),"#")
